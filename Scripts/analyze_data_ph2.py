...
study_id = 'Crown_Pilot_Phase2'
num_cpu = 46
processed_data_file_path = '../Phase_2_PDO_Data/Processed_Data/Argonne_ph2_Combined_FullSet_shared_preprocessed.txt'
feature_category_file_path = '../Phase_1_Cell_Line_Data/Configuration/feature_category_ph2_pdo.txt'
generated_data_dir = '../Phase_2_PDO_Data/Processed_Data/Processed_Data_feature_category_ph2_pdo/'
fitted_curve_plots_dir = generated_data_dir + 'Fitted_Curve_Plots/'
all_feature_category_file_path = '../Phase_1_Cell_Line_Data/Configuration/feature_category_ph2_pdo.txt'
