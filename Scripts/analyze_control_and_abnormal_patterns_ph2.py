...
control_result_dir = '../Phase_2_PDO_Data/Processed_Data/Control_Analysis_Results/'
abnormal_result_dir = '../Phase_2_PDO_Data/Processed_Data/Abnormal_Analysis_Results/'
...
if not os.path.exists(abnormal_result_dir):
    os.makedirs(abnormal_result_dir)
