...
# fc = {}
# fc['Fraction_living_cells'] = 'Norm___E0_1___Einf_0_1'
# all_exp = all_exp[[50, 100, 150, 200]]

# info_id = np.where(np.invert(np.isin(res.columns, list(fc.keys()))))[0]
# fit_dose_response_curve(study_id=study_id, res=res, info_col=res.columns[info_id], fc=fc,
#                         ec50_bound=(min_ec50, max_ec50), hs_bound=(min_hs, max_hs),
#                         all_exp=all_exp, ori_control=control,
#                         plot_dir='../../Phase_1_Cell_Line_Data/Processed_Data/Fitted_Curve_Plots/',
#                         data_file_path='../../Phase_1_Cell_Line_Data/Processed_Data/Results.pkl')
